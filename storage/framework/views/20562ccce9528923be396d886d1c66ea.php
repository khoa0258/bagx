...
<div class="container py-4">
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('checkout.index')); ?>">Thanh toán</a></li>
    ...
    <div class="card-body p-4 p-md-5">
      ...
      <div class="mb-4">
        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between">
          ...
          <span class="fw-medium text-dark"><?php echo e($nameToShow); ?></span>
        </div>

        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between">
          <span class="text-muted big">Email:</span>
          <span class="fw-medium text-dark"><?php echo e($emailToShow); ?></span>
        </div>

        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between">
          <span class="text-muted big">Số điện thoại:</span>
          <span class="fw-medium text-dark"><?php echo e($phoneToShow); ?></span>
        </div>

        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between">
          <span class="text-muted big">Địa chỉ giao hàng:</span>
          <span class="fw-medium text-dark"><?php echo e($addressToShow); ?></span>
        </div>

        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between">
          <span class="text-muted big">Phương thức thanh toán:</span>
          <span class="fw-semibold text-primary"><?php echo e($paymentMethodText); ?></span>
        </div>
        ...
        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between align-items-center">
          ...
          <span class="badge badge-soft-warning rounded-pill px-3 py-2"><?php echo e($statusText); ?></span>
        </div>

        <div class="border-bottom pb-2 mb-2 d-flex justify-content-between">
          <span class="text-muted big">Ngày đặt hàng:</span>
          <span class="fw-medium text-dark"><?php echo e($orderDate); ?></span>
        </div>
        ...
        <div class="bg-body-tertiary rounded-3 p-3 d-flex justify-content-between align-items-center">
          ...
          <span class="fs-4 fw-bold text-success"><?php echo e($totalFormatted); ?></span>
        </div>
      </div>
      ...
      <div class="d-grid gap-2">
        ...
        <a href="<?php echo e(route('orders.show', $order->id)); ?>" class="btn btn-outline-secondary btn-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/bagxidvn/public_html/resources/views/frontend/checkout/success.blade.php ENDPATH**/ ?>