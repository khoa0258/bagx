...
<div class="row">
    ...
    <div class="card bg-danger text-white">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div>
                    <h4>{{ number_format($stats['total_revenue_vnpay']) }}đ</h4>
                    <p class="mb-0">Đã thanh toán qua VNPAY</p>
                    <!--<small>{{ number_format($stats['vnpay_orders_count']) }} đơn</small>-->
                </div>
                <div class="align-self-center">
...
<div class="col-md-3 mb-4">
    <div class="card bg-secondary text-white">
        <div class="card-body">
            <div class="d-flex justify-content-between">
                <div>
                    <h4>{{ number_format($stats['total_revenue_cod']) }}đ</h4>
                    <p class="mb-0">Thanh toán khi nhận hàng</p>
                    <!--<small>{{ number_format($stats['cod_orders_count']) }} đơn</small>-->
                </div>
                <div class="align-self-center">
