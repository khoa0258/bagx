...
<head>
    ...
    <title>@yield('title', 'Trang chủ') - Bagx</title>
            ...
            <div class="row">
                ...
                <div class="col-md-2 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{ route('home') }}" class="text-decoration-none text-muted">Trang chủ</a></li>
                        <li><a href="{{ route('products.index') }}" class="text-decoration-none text-muted">Sản phẩm</a></li>
